...
/opt/IBM/WebSphere/AppServer/bin/manageprofiles.sh -create -profileName AppSrv02 -enableService false -hostname dnx23.datanix.comm -serverName server2 -templatePath /opt/IBM/WebSphere/AppServer/profileTemplates/default -profilePath /opt/IBM/WebSphere/AppServer/profiles/AppSrv02  -enableAdminSecurity true -adminUserName wasadmin -adminPassword FPS2Snippers#$
...
/opt/IBM/WebSphere/AppServer/profiles/AppSrv02/bin/startServer.sh server2
